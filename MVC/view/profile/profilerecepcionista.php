            ...
            <div class="left">
                <div class="container-menu">
                    ...
                    <div class="menu">
                        ...
                        <div>
                            <button onclick="container(2)">RESERVAS</button>
                        </div>
                        <div>
                            <button onclick="container(3)">CLIENTES</button>
                        </div>
                        <div>
                            <a href="inventario.html"><button onclick="container(4)">INVENTARIO</button></a>
                        </div>
                        <div>
