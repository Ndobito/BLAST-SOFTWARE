...
<br>
        ...
        <input type="text" id="precio de venta" name="precio de venta" placeholder="agrega el precio de venta del producto">
<br>
        <label for="nombre">Cantidad existente:</label>
        <input type="text" id="Cantidad existente" name="Cantidad existente" placeholder="agrega la Cantidad existente del producto">
<br>
