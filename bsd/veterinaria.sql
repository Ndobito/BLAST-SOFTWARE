...
CREATE TABLE `cirugia` (
  `idcir` int(11) NOT NULL COMMENT 'id de la cirugia',
...
CREATE TABLE `cliente` (
  `idcli` int(11) NOT NULL COMMENT 'identificador del cliente',
...
CREATE TABLE `diagnostico` (
  `numdia` int(11) NOT NULL COMMENT 'NUEMERO DE DIAGOSTICO',
...
CREATE TABLE `personal` (
  `idper` int(11) NOT NULL COMMENT 'id que se le dara al personal',
...
CREATE TABLE `proveedor` (
  `idprov` int(11) NOT NULL COMMENT 'ID QUE SE LE IDENTIFICARA AL PROVEEDOR',
