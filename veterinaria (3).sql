...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-08-2023 a las 23:07:06
...
CREATE TABLE `administrador` (
  ...
  `nickadmin` varchar(255) NOT NULL COMMENT 'Nombre de usuario de \r\nadministrador',
...
INSERT INTO `administrador` (`idadmin`, `nomadmin`, `apeadmin`, `nickadmin`, `passadmin`, `emaadmin`, `diradmin`, `teladmin`, `teladmin2`, `fileadmin`, `privilegios`) VALUES
(1, 'Alejandro', 'Cuellar', 'arcelot27', 'ec111adbc225617a70ccd332601c8767', 'arcelot27@gmail.com', 'vereda', '313321514', '3224091130', '', 4);
...
CREATE TABLE `cliente` (
  `numid` int(11) NOT NULL COMMENT 'Numero de Identificacion del Cliente',
  ...
  `tzonecli` varchar(255) NOT NULL COMMENT 'Zona en la cual se encuentra ubicado el cliente',
  `telcli` varchar(255) NOT NULL COMMENT 'Numero de Telefono del cliente',
  `telaltcli` varchar(255) DEFAULT NULL COMMENT 'Numero de telefono alternativo del cliente',
...
INSERT INTO `cliente` (`numid`, `nomcli`, `emacli`, `usercli`, `passcli`, `dircli`, `tzonecli`, `telcli`, `telaltcli`, `filecli`) VALUES
(1029981035, 'Jose Alejandro  Cuellar Menza', 'jcuellarmenza@gmail.com', 'Asalejo', '6ebe5ec79e751013949db54c794ecee8', 'calle 8 # 6-87', 'urbana', '3133215141', '3224091130', NULL);
...
CREATE TABLE `colaborador` (
  ...
  `dnicol` int(10) NOT NULL,
  `nomcol` varchar(255) NOT NULL COMMENT 'Nombre del colaborador',
  `nickcol` varchar(255) NOT NULL COMMENT 'Nombre de Usuario del colaborador',
...
INSERT INTO `colaborador` (`idcol`, `dnicol`, `nomcol`, `nickcol`, `emacol`, `passcol`, `dircol`, `telcol`, `rolcol`, `filecol`) VALUES
(1, 0, 'Ronaldo', 'ronal07', 'marpex@gmail.com', 'mar123', 'Calle 4 #12-34 La Paicol', '3124563454', 'veterinario', 'img/vet1.png');
...
(8, 'Manolo', '12', 'Macho', 'canino', 1029981035);
...
(1029981035, 'Jose Alejandro', 'Cuellar Menza', 'Asalejo1', 'd00cb1987c6c69dc665e046a11dccc6b', 'jcuellarmenza@gmail.com', 'calle 8 # 6-87', 'urbana', '3133215141', '', 4);
...
--
ALTER TABLE `mascota`
  ADD CONSTRAINT `mascota_ibfk_1` FOREIGN KEY (`idcli`) REFERENCES `cliente` (`numid`);
...
ALTER TABLE `registroxservicios`
  ...
  ADD CONSTRAINT `registroxservicios_ibfk_4` FOREIGN KEY (`idcli`) REFERENCES `cliente` (`numid`);
